...
typedef unsigned char     BYTE, U8, UCHAR, BOOL,uchar;
...
//图像中线边线
extern uint8 imgbuff[600];                             //定义存储接收图像的数组
extern uint8 img[60][80];                           //由于鹰眼摄像头是一字节8个像素，因而需要解压为 1字节1个像素，方便处理
extern uint8 img2[60][80];
extern uint8 Left_line[60],Right_line[60];                             //定义数组存储边线值
extern int16 middleline_last,middleline;
extern uint8 center[60];
extern uint8 center_ave;
extern uint8 width[60];
extern uint8 sdian,sum,swan_flag;
//舵机 P,D初始化
//extern int8 S3010_Kp,S3010_Kd,zuo_Kp,you_Kp,z_w,y_w;
extern int servo_error[20];
extern int8 error,error_last;
extern uint16 servo_duty;
extern uint16 servo_mid;
//图像环路标志位

extern uint8 Hlin_flag;//进环路左边线丢线
extern uint8 Hrin_flag;//出环路右边线丢线
extern uint8 Hlin_flag0;
extern uint8 Hrin_flag0;
extern uint8 Hlin_flag1;
extern uint8 Hrin_flag1;
extern uint8 Hlout_flag ;
extern uint8 Hlout_flag0;
extern uint8 Hrout_flag ;
extern uint8 Hrout_flag0;

extern uint8 Huanlzhi_flag;
extern uint8 Huanl_point;
extern uint16 Huanlzhi_point;
extern uint16 zhizi_point1,shizi_point2;
extern uint8 shizi_flag1,shizi_flag2,shizi_FLAG;
extern uint8 HuanlzhiL_point,HuanlzhiR_point;
//图像标志位
extern uint8 stop_flag;
extern uint8 stra_flag;
extern uint16 Hdist1;
extern uint16 Hdist2;
extern uint8 guoguaidian_flag;
extern uint8 zuoguaidian,youguaidian,zuoshangguaidian,youshangguaidian;

//电机参数
extern uint16 speed;
extern uint16 speed_set;
extern int16 speed_error[10];
extern int16 motor_pwm;
extern uint16 motor_Ki;
extern uint16 motor_Kp;
extern uint16 motor_Kd;
